    ...
    <Box minHeight="100vh" position="relative">
      ...
      <Box maxWidth={1100} mx="auto" px={3} py={4}>
        ...
        <Box display="flex" gap={1.5} flexWrap="wrap" mb={3}>
          <Button variant="contained" onClick={() => router.push("/clinician/integrations")}>
            EHR Integrations
          </Button>
          <Button variant="outlined" onClick={() => router.push("/clinician/rtm")}>
            RTM Billing
          </Button>
          <Button variant="outlined" onClick={() => router.push("/clinician/billing")}>
            SaaS Billing ($80/pt)
          </Button>
        </Box>
